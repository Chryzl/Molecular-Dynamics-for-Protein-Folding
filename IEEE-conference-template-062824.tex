...
We extend this framework to deep learning, treating neural network training as a physical process on a loss landscape. Our analysis supports previous research that find training dynamics to resemble high-dimensional random walks rather than structured folding pathways. This finding highlights that the lack of intuitive collective variables in deep learning limits the direct application of these tools due to the high dimensionality of parameter space.
\end{abstract}
